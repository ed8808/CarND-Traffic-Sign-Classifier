...
I normalized the image data from 0..255 to -1..1 because this will help to ease for subsequent CNN to process
...
The model was able to correctly guess 4 of the 5 traffic signs, which gives an accuracy of 60%. This compares favorably to the accuracy on the test set of ...
